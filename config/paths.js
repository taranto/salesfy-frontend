...
module.exports = {
  ...
  appPublic: resolveApp('public'),
  appHtml: resolveApp('public/index.html'),
  appIndexJs: resolveApp('./index.web.tsx'),
  appPackageJson: resolveApp('package.json'),
  appSrc: resolveApp('.'),
  yarnLockFile: resolveApp('yarn.lock'),
  testsSetup: resolveApp('src/setupTests.ts'),
  ...
  appTsConfig: resolveApp('tsconfig.json'),
  appTsProdConfig: resolveApp('tsconfig.json'),
  appTsTestConfig: resolveApp('tsconfig.json'),
  appTsLint: resolveApp('tslint.json'),
  publicUrl: getPublicUrl(resolveApp('package.json')),
  servedPath: getServedPath(resolveApp('package.json')),
...
if (
  ...
  module.exports = {
    ...
    appTsProdConfig: resolveOwn('template/tsconfig.json'),
    appTsLint: resolveOwn('template/tslint.json'),
    appTsTestConfig: resolveOwn('template/tsconfig.json'),
