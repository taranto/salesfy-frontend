    ...
    (0, _defineProperty2["default"])(this, "findDataByPath", function (renderData, path) {
      if (_this.isDataType("tree")) {
        var node = path.reduce(function (result, current) {
          return result.tableData && result.tableData.childRows && result.tableData.childRows[current];
        }, {
          tableData: {
    ...
    value: function groupData() {
      ...
      var subData = tmpData.reduce(function (result, current) {
        ...
        object = groups.reduce(function (o, colDef) {
          var value = current[colDef.field] || (0, _2.byString)(current, colDef.field);
